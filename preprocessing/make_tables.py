...
if __name__ == '__main__':
    ...
    _renaming_pa_s1 = {"c6c2wine": "c6c2wine", "c6b2beer": "c6b2beer", "c6b3soda": "c6b3soda",
    ...
    _renaming_pa_s1.update(_renaming_pa_both)

    _renaming_pa_s2 = {"q5aagsto": "q5aagsto", "q5esnu": "q5aagsto", "q5esnust": "q5esnust", "q5fagsnu": "q5fagsnu",
    ...
    _renaming_pa_s2.update(_renaming_pa_both)
    ...
    _to_drop_ex_both = list(_renaming_pa_both.keys())
    _to_drop_ex_both.remove('ID')

    _to_drop_ex_s1 = list(_renaming_pa_s1.keys())
    _to_drop_ex_s1.remove('ID')

    _to_drop_ex_s2 = list(_renaming_pa_s2.keys())
    _to_drop_ex_s2.remove('ID')
    ...
    parallel_parsing(source="./preprocessed/surveys/mixed.csv",
                     ...
                     renaming_pa=_renaming_pa_both,
                     renaming_ex=_renaming_ex,
                     to_drop_ex=_to_drop_ex_both)
    ...
    parallel_parsing(source="./preprocessed/surveys/s1.csv",
                     ...
                     renaming_pa=_renaming_pa_s1,
                     renaming_ex=_renaming_ex,
                     to_drop_ex=_to_drop_ex_s1)
    ...
    parallel_parsing(source="./preprocessed/surveys/s2.csv",
                     ...
                     renaming_pa=_renaming_pa_s2,
                     renaming_ex=_renaming_ex,
                     to_drop_ex=_to_drop_ex_s2)
