...
def make_rows(original_path, changed_diagnosis, diag, preprocessed, group, drop_diag, grouped, drop_col):
    # change diagnosis
    change_diagnosis(path=original_path, dest=changed_diagnosis, new_diagnosis=diag)
...
def make_all(diag, drop_diag, drop_col, group, raw_dir, name, idv, renaming_en,
             renaming_ev, pre_dir="", final_dir="", int_steps=False):
    if pre_dir is "":
        pre_dir = raw_dir
    if final_dir is "":
        final_dir = raw_dir
    ...
    make_rows(original_path, changed_diagnosis, diag, preprocessed, group, drop_diag, grouped, drop_col)

    make_tables(renaming_en, renaming_ev, grouped, entity_dest, event_dest, idv)
...
if __name__ == "__main__":
    ...
    _renaming_ev = {'ID': 'PatientID', 'diagnosisdate': 'DiagnosisDate', 'diagnosisnumber': 'DiagnosisNbr',
                    'type': 'ExamType', 'diagnosis1': 'Diagnosis', 'diagnosis2': 'MorphologyCode', 'stage': 'Stage',
                    'lab_nr': 'LaboratoryNbr', 'reg': 'Region', 'sincelast': 'TimeSinceLast', 'age': 'Age'}
    ...
    make_all(_diag, _drop_diag, _drop_col, _group, _raw_dir, _name, _idv, _renaming_en, _renaming_ev)
    ...
    _renaming_en_both = {
        ...
        "q20know": "q20know", "q21necc": "q21necc", "q23heigh": "q23heigh", "q23weigh": "q23weigh"
    }

    make_all(_diag, _drop_diag, _drop_col, _group, _raw_dir, _name, _idv, _renaming_en_both, _renaming_ev)

    # SURVEY 1

    _raw_dir, _name = "./data/surveys/", "s1.csv"

    _renaming_en_s1 = {"c6c2wine": "c6c2wine", "c6b2beer": "c6b2beer", "c6b3soda": "c6b3soda",
                       "c6b4rwin": "c6b4rwin", "c6b5wwin": "c6b5wwin", "c6b6dwin": "c6b6dwin",
                       "c6b7vodk": "c6b7vodk", "c6aagdrk": "c6aagdrk", "c7aagepr": "c7aagepr",
                       "c8aageco": "c8aageco", "c8bhormc": "c8bhormc", "c8cyrhor": "c8cyrhor", "c11conew": "c11conew"}

    _renaming_en_s1.update(_renaming_en_both)

    make_all(_diag, _drop_diag, _drop_col, _group, _raw_dir, _name, _idv, _renaming_en_s1, _renaming_ev)

    # SURVEY 2

    _raw_dir, _name = "./data/surveys/", "s2.csv"

    _renaming_en_s2 = {"q5aagsto": "q5aagsto", "q5esnu": "q5aagsto", "q5esnust": "q5esnust", "q5fagsnu": "q5fagsnu",
    ...
    make_all(_diag, _drop_diag, _drop_col, _group, _raw_dir, _name, _idv, _renaming_en_s2, _renaming_ev)
