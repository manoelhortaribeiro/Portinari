...
class Graph:
    ...
    def get_node_desc(self, number):
        string = ""
        for val in self.get_node(number)["display_value"]:
            string += val + " | "
    ...
    def get_edge_desc(self, number1, number2):
        string = ""
        for val in self.get_edge(number1, number2)["display_value"]:
            string += val + " | "
